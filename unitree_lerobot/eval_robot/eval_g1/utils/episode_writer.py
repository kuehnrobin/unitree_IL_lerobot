...
class EpisodeWriter():
    ...
    def text_desc(self):
        self.text = {
            "goal": "Robot policy evaluation task.",
            "desc": "Evaluate robot policy performance with optional data recording for analysis.",
            "steps":"step1: initialize robot. step2: run policy. step3: record data if enabled",
        }
